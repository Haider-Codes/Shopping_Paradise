                ...
                <div class="col-md-6">
                    <form class="form" action="register" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="<%=rs.getString(2)%>" type="text" name="username"/>
                        </div>
                        <div class="form-group">
                            <label for="email">Email ID</label>
                            <input class="form-control" value="<%=rs.getString(3) %>" type="text" name="email"/>
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input class="form-control" value="<%=rs.getString(5) %>" type="password" name="password"/>
                        </div>
                        <div class="form-group">
                            <label for="phno">Phone Number</label>
                            <input class="form-control" value="<%=rs.getString(4) %>" type="text" name="phno"/>
                        </div>
                        <div class="form-group">
                            <label for="gender">Gender</label>
                            <input class="radio-inline" value="<%=rs.getString(6) %>" type="radio" name="gender" value="Male"/> Male
                        ...
                        %>
                        <div class="form-group">                    
                        <input class="form-control btn-primary btn-lg" type="submit" value="UPDATE PROFILE"/>
                        </div>
                        <div class="form-group">                    
                            &nbsp;
                        </div>
