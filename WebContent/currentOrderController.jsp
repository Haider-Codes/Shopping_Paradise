...
while(rs.next())
{
	...
	while(rs1.next())
	{
		...
		s1.executeUpdate("insert into current_order(current_order_dt,current_order_amount,current_product_name,current_user_id) values ('"+dat+"',"+amount+",'"+product_name+"',"+user_id+");"); 
		}
	response.sendRedirect("orderController.jsp?pay="+pay+"&&bill_id="+bill_id);
}
