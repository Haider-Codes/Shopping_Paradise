...
<link  type="text/css" href="preloader.css" rel="stylesheet">
</head>
<body onload="load();">
...
"<button class='btn btn-outline-success my-2 my-sm-0' type='submit'>Search</button></form>";
		  ...
		  for(Cookie c:ck)
		  {
			  if(c.getName().equals("user"))
			  {
				  ...
				  text="<li class='nav-item'><a class='nav-link' href='admin.jsp'>Welcome, "+user+"</a></li>"+
...
%>
  ...
  <marquee  bgcolor="black" style="margin-top:90px;color:white;font-family:Comic Sans MS;"behavior="alternate">WELCOME TO SHOPPING PARADISE!! INDIA'S BEST SELLING WEBSITE</marquee>
  <!-- Page Content -->
    ...
    <div class="row">
      ...
      <div class="col-lg-3" style="padding:5px">
        ...
        while(rs2.next())
        	{
        	%>
          <a href="categories.jsp?cid=<%=rs2.getInt(1) %>" class="list-group-item"><%=rs2.getString(2) %></a>
          <%
        	}
          %>
...
ResultSet rs1=s1.executeQuery("select * from product");
while(rs1.next())
{
	%>
